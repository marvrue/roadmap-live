...
const SCHEMA_EXAMPLE = {
  matches: [{ item_id: 'listing-editor', confidence: 0.92, status_hint: 'done' }],
  open_points: [{ item_id: 'listing-editor', text: 'Reviewer asked for image size validation', source: 'pr:42#comment:1893', resolved: false }],
  unplanned: [{ title: 'Wishlist', reason: 'no matching item' }],
};
