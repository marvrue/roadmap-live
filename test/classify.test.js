...
test('prompt contains items, schema, comments with sources and the language', async () => {
  ...
  assert.ok(prompt.includes('id: checkout | title: Checkout with reserved copies | milestone: Buying flow'));
  ...
  assert.ok(prompt.includes('"item_id": "listing-editor"'), 'schema example');
